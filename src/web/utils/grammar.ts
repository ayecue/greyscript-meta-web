...
export const GreyScriptLanguage = {
  ...
  class:
    /\b(aptClient|computer|crypto|file|ftpShell|metaLib|metaMail|metaxploit|netSession|port|router|shell|blockchain|service|subWallet|wallet|coin|ctfEvent|debugLibrary|trafficNet|smartAppliance)\b/,
  method: [
    {
      // ctfEvent
      pattern:
    ...
    },
    {
      // file
      pattern:
        /\.(chmod|copy|move|rename|path|parent|name|get_content|set_content|is_binary|has_permission|delete|get_folders|get_files|permissions|owner|set_owner|group|set_group|size|meta_info|symlink|is_symlink)\b/
    },
    {
      // ftpShell
    ...
    {
      // metaLib
      pattern: /\.(overflow|version|lib_name|debug_tools|is_patched)\b/
    },
    {
      // metaMail
    ...
    },
    {
      // blockchain
      pattern:
        /\.(coin_price|show_history|amount_mined|get_coin|login_wallet|create_wallet|delete_coin|get_coin_name)\b/
    },
    {
      // service
