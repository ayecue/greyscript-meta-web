...
export const GreyScriptLanguage = {
  ...
  method: [
    ...
    {
      // metaLib
      pattern: /\.(overflow|version|lib_name|debug_tools|payload)\b/
    },
    {
      // metaMail
